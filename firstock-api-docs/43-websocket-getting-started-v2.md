...
> Source: https://firstock.in/api/docs/getting-started-v2/
...
```
wss://socket.firstock.in/V2/ws?userId=AB1234&jKey=cae0e3af6f26583c0e19b83c91f207466199b7fef5e66160b8ff02511205d651&source=developer-api
```
