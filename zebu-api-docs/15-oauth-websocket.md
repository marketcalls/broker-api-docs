...
> Source: <https://zebumyntapi.web.app/OAuth/Web%20Socket/>

> **OAuth Authentication Required**
>
> WebSocket connections require OAuth authentication. You must first obtain an access token through the OAuth flow before establishing WebSocket connections.

## Overview

The WebSocket API provides real-time market data and order updates including:
- **Real-time Market Data**: Live price feeds, touchline data, and market depth
- **Order Updates**: Real-time order status changes and trade confirmations
- **Market Depth**: Level 2 market data with bid/ask prices and quantities
