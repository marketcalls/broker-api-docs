...
| --- | --- | --- |
| RequestCode *required* | int | Code for subscribing to particular data mode. `23` for Full Market Depth.  Refer to [feed request code](/docs/v2/annexure/#feed-request-code) to subscribe to required data mode |
| InstrumentCount *required* | int | No. of instruments to subscribe from this request |
| InstrumentList.ExchangeSegment *required* | enum string | Exchange Segment of instrument to be subscribed as found in [Annexure](../annexure/#exchange-segment) |
| InstrumentList.SecurityId *required* | string | Exchange standard ID for each scrip. Refer [here](../instruments/) |
...
| `4` | [ ] byte | `1` | Exchange Segment can be referred in [Annexure](../annexure/#exchange-segment) |
...
| Bytes | Type | Size | Description |
| --- | --- | --- | --- |
| `0-12` | [ ] array | `12` | [Response Header](#response-header)  `41` for Bid Data (Buy)  `51` for Ask Data (Sell)  Refer to [enum](/docs/v2/annexure/#feed-response-code) for values |
...
| Bytes | Type | Size | Description |
| --- | --- | --- | --- |
| `0-12` | [ ] array | `8` | [Response Header](#request-header) with code `50`  Refer to [enum](/docs/v2/annexure/#feed-response-code) for values |
