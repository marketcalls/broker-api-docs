...
| Symbol | string | Symbol in which order is placed - Refer [here](../instruments/) |
...
| DisplayName | string | Name of instrument in which order is placed - Refer [here](../instruments/) |
...
| Multiplier | int |or In case of commodity and currency contracts |
